...
## [Unreleased]
### Added
- Added `covariance()` function to GEKKO for scalar and matrix covariance calculations
- The `covariance()` function uses native GEKKO equations with input validation
### Changed
